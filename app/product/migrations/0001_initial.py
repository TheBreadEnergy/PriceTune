    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Название сообщения", max_length=255),
                ),
                (
                    "value",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_show_name",
                    models.BooleanField(default=True, help_text="Отображать название группы?"),
                ),
                (
                    "description_end",
                    models.TextField(
                        blank=True,
                        help_text="Описание в конце",
                        max_length=1024,
                        null=True,
                    ),
                ),
